...
func (m *MockVaultClient) Exists(path string) (bool, error) {
...
func (mr *MockVaultClientMockRecorder) Exists(path interface{}) *gomock.Call {
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Exists", reflect.TypeOf((*MockVaultClient)(nil).Exists), path)
}
