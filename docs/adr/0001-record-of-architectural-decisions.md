# 1. Record of Architectural Decisions
...
We should keep ADRs in the project repository under doc/arch/adr-NNN.md

We should use a lightweight text formatting language like Markdown or Textile.

However, until we have a Git repo for the project, we will record them as documents in Google Drive.
...
Taken from http://thinkrelevance.com/blog/2011/11/15/documenting-architecture-decisions for reference.
