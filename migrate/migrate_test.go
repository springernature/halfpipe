...
type MockController struct {
	processFunc func(man manifest.Manifest) (config halfpipe.Config, results result.LintResults)
}
...
func (m MockController) Process(man manifest.Manifest) (config halfpipe.Config, results result.LintResults) {
